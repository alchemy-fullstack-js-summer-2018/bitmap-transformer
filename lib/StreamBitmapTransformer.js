        ...
        return new Promise((resolve, reject) => {
            ...
            readStream.on('data', chunk => {
                ...
                for(let i = 0; i < chunk.length; i += 3) {
                    ...
                    //pass this chunk to the transform function designated in test
                    transformation(pixel);
                    //changes transformed pixels chunk in buffer
                    chunk.writeUInt8(pixel.b, i);
                    chunk.writeUInt8(pixel.g, i + 1);
                    chunk.writeUInt8(pixel.r, i + 2);
                }
                //writes chunk to designated output file, loops back to for loop until end of file
